...
#
# Vendored from Rails, unmodified except for this header and the removal of
# Rails' own `require "test_helper"` line.
#
#   Source:  activestorage/test/service/shared_service_tests.rb
#   Version: v8.1.3.1
#   URL:     https://github.com/rails/rails/blob/v8.1.3.1/activestorage/test/service/shared_service_tests.rb
#   License: MIT, Copyright (c) David Heinemeier Hansson (see LICENSE.txt of Rails)
#
# This is the conformance suite every first-party ActiveStorage service is held
# to. It is vendored rather than adapted on purpose: the point of running it is
# that it was written by somebody who had never heard of this library and has no
# stake in it passing. Do not edit it to make it pass. If a case genuinely
# cannot apply, skip it explicitly in the including test and say why.
#
# Refresh with:
#   curl -o test/support/shared_service_tests.rb \
#     https://raw.githubusercontent.com/rails/rails/vX.Y.Z/activestorage/test/service/shared_service_tests.rb
